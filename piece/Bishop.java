...
public class Bishop extends Piece implements Move{
    ...
    public List<Location> getValidMoves(Board board) {
        ...
        getMoves(possibleMoves, board.getBoardMap(), current, 1, 1);
        getMoves(possibleMoves, board.getBoardMap(), current, 1, -1);
        getMoves(possibleMoves, board.getBoardMap(), current, -1, 1);
        getMoves(possibleMoves, board.getBoardMap(), current, -1, -1);
    ...
    private void getMoves(List<Location> possibleMoves, Map<Location, Square> boardMap, Location current,  int rankOffset, int fileOffset){
